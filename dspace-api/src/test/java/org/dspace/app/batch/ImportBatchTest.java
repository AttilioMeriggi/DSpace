...
//     * log4j category
//     */
//    private static final Logger log = LogManager.getLogger(ImportBatchTest.class);
//
...
//                        if (role.getScope() == Role.Scope.COLLECTION) {
//                            WorkflowUtils.createCollectionWorkflowRole(context, collection, roleName.toLowerCase(),
//                                    roleGroup);
//                        }
//                    }
...
//     * Using francesco@sample.ue as context user.
//     * 
//     * Set workspace item status to workflow.
//     * 
//     * @throws IOException
//     */
//    @Test
...
//            String name, String description, UUID embargoGroup) throws SQLException, IOException, URISyntaxException {
//        ImpRecord impRecord = impRecordService.findByID(context, impRecordKey);
